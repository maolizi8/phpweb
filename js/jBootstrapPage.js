(function($) {
	$.fn.jBootstrapPage = function(config) {
		...
		return this.each(function() {
			...
			init();
			bindALL();
			onClickPage($this.find('li.page').find('a[page="1"]'))
			...
			function init() {
				...
				$this.append('<li class="disabled" id="beginBtn"><a class="first" href="#">首页</a></li>');
				...
				$this.append('<li id="endBtn" data-count=' + pageCount + '><a class="last" href="#">末页</a></li>');
			...
			function init_() {
				...
				var pageCount = c.maxPages < c.maxPageButton ? c.maxPages : c.maxPageButton;
				var pNum = 0;
				for(var index = (c.maxPages - c.maxPageButton + 1); index <= c.maxPages; index++) {
					pNum++;
					$this.append('<li class="page" pNum="' + pNum + '"><a href="#" page="' + index + '">' + index + '</a></li>');
				}
